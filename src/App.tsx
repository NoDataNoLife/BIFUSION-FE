      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/dashboard" element={<DashboardPage />}>
            ...
            {/* Augment Workflow */}
            <Route path="projects/:projectId/jobs/:jobId/setup" element={<AugmentSetupPage />} />
            <Route path="projects/:projectId/jobs/:jobId/progress" element={<AugmentProgressPage />} />
            <Route path="projects/:projectId/jobs/:jobId/result" element={<AugmentResultPage />} />
            
            {/* Train Workflow */}
            <Route path="projects/:projectId/train/:jobId/setup" element={<TrainSetupPage />} />
            <Route path="projects/:projectId/train/:jobId/progress" element={<TrainProgressPage />} />
            <Route path="projects/:projectId/train/:jobId/result" element={<TrainResultPage />} />
            
            {/* Inference Workflow */}
            <Route path="projects/:projectId/inference/:jobId/setup" element={<InferenceSetupPage />} />
            <Route path="projects/:projectId/inference/:jobId/progress" element={<InferenceProgressPage />} />
            <Route path="projects/:projectId/inference/:jobId/result" element={<InferenceResultPage />} />
