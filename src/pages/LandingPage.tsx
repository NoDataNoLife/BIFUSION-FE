...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 transition-colors font-sans overflow-x-hidden">
      ...
      {/* 2. FEATURE GRID - [land-proto Structure] */}
        ...
        <div className="container mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-muted-foreground transition-colors">
              bifusion이 제공하는 혁신적인 의료 AI 개발 환경의 핵심 기능입니다.
            </p>
          </div>
      ...
      {/* 3. PROCESS FLOW - [land-proto Structure] */}
      <section className="py-24 px-6">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 space-y-8 text-center lg:text-left">
              <h2 className="text-4xl font-bold font-hbios transition-colors text-foreground">
                How it <br />
                <span className="text-primary italic transition-colors">
                  Works
                </span>
              </h2>
              <div className="space-y-6">
                <ProcessStep
                  number="01"
                  title="Augment"
                  desc="원본 데이터를 기반으로 다양한 증강 기법을 적용하여 풍부한 데이터셋을 구축합니다."
                />
                <ProcessStep
                  number="02"
                  title="Train"
                  desc="구축된 데이터셋을 통해 고성능 AI 모델을 학습시키고 결과를 분석합니다."
                />
                <ProcessStep
                  number="03"
                  title="Inference"
                  desc="학습 완료된 모델을 배포하고 실제 진단 보조 및 연구에 활용합니다."
                />
              </div>
            </div>
            <div className="flex-1 w-full aspect-square bg-card rounded-[3rem] border border-border flex items-center justify-center p-12 transition-colors">
              <Terminal
                className="text-primary/10 w-full h-full transition-colors"
                strokeWidth={1}
              />
            </div>
          </div>
      ...
      {/* 4. SHOWCASE / MOCKUP - [land-proto Structure] */}
      ...
      {/* 5. FINAL CTA - [land-proto Structure] */}
      <section className="py-32 px-6 text-center transition-colors">
        <div className="container mx-auto max-w-3xl">
          ...
          <button className="h-20 px-12 bg-card border-2 border-border rounded-3xl flex items-center justify-center gap-4 hover:bg-muted transition-all mx-auto active:scale-[0.98]">
