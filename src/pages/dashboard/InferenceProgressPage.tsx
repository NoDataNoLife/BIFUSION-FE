    ...
    <div className="min-h-screen bg-gray-50/50 flex flex-col">
        ...
        <div className="max-w-4xl mx-auto px-8 py-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl font-black text-gray-900 tracking-tight">AI 모델 추론 중</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="max-w-2xl w-full bg-white rounded-[3rem] border border-gray-100 shadow-2xl shadow-primary/5 p-16 space-y-12">
          <h1 className="text-3xl font-black text-gray-900 text-center tracking-tight">이미지 분류 중</h1>
          ...
          {/* Current Step (Gray box) */}
          <div className="bg-gray-50 rounded-3xl p-10 border border-gray-100 text-center space-y-2">
            <p className="text-xs font-black text-gray-400 uppercase tracking-widest">현재 상태</p>
          ...
          <div className="flex justify-center pt-4">
            <button
              ...
              className="px-10 py-4 border-2 border-red-100 text-red-500 rounded-2xl font-black text-sm hover:bg-red-50 transition-all active:scale-95"
            >
              작업 취소하기
            </button>
          </div>
