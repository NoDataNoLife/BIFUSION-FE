    ...
    <div className="min-h-screen bg-gray-50/50 pb-20">
      ...
      <div className="max-w-6xl mx-auto px-8 py-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-card rounded-4xl p-8 border-2 border-green-500 bg-green-50 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-card rounded-[2.5rem] p-10 border border-border shadow-sm space-y-6">
            ...
            <div className="aspect-video bg-muted rounded-3xl border border-border flex items-center justify-center text-muted-foreground italic font-bold">
              [클래스 비율 파이 차트 시각화]
            </div>
          </div>
          <div className="bg-card rounded-[2.5rem] p-10 border border-border shadow-sm space-y-6">
              ...
              {mockResults.map((item) => (
                <tr key={item.id} className="group hover:bg-gray-50/50 transition-colors">
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 bg-muted rounded-2xl border border-border group-hover:scale-110 transition-transform shadow-sm" />
        ...
        {/* Comments Section */}
        <div className="bg-card rounded-[2.5rem] p-10 border border-border shadow-sm space-y-10">
          <div className="flex items-center gap-3">
          ...
          <div className="space-y-8 pt-4">
            {comments.map((c) => (
              <div key={c.id} className="flex gap-5 group">
                <img src={c.avatar} alt={c.user} className="w-12 h-12 rounded-2xl bg-muted ring-4 ring-gray-50 shrink-0" />
                <div className="flex-1 space-y-2">
                  ...
                  <div className="p-6 bg-muted rounded-3xl rounded-tl-none border border-border text-muted-foreground font-medium leading-relaxed">
                    {c.content}
                  </div>
                </div>
              </div>
